...
def modify_html_file(file_path):
    """修改HTML文件，添加兼容Windows 7的最大化窗口代码"""
    try:
...
"""
        ...
        messagebox.showerror("错误", f"修改HTML文件时出错: {str(e)}")
...
def create_gui():
    try:
        ...
        # 添加说明标签
        label = tk.Label(frame, text="请选择你的命运:", 
                        font=('微软雅黑', 24) if platform.release() == '7' else ('Arial', 24))
        ...
        lucky_btn = tk.Button(
            ...
            bg='green', 
            fg='white',
            font=('微软雅黑', 18) if platform.release() == '7' else ('Arial', 18),
            width=15,
            height=3,
        ...
        exit_btn = tk.Button(
            ...
            font=('微软雅黑', 14) if platform.release() == '7' else ('Arial', 14),
            width=10,
            height=1
        )
